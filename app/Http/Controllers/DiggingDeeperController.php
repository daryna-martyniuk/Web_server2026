...
class DiggingDeeperController extends Controller
{
    ...
    public function collections()
    {
        ...
        $newItem = new \stdClass;
        $newItem->id = 9999;
        $newItem->item_id = 9999; // додаємо, щоб не ламалося сортування sortByDesc('item_id')
        $newItem->created_at = Carbon::now(); // додаємо дату

        $newItem2 = new \stdClass;
        $newItem2->id = 8888;
        $newItem2->item_id = 8888; // додаємо для сортування
        $newItem2->created_at = Carbon::now(); // додаємо дату
